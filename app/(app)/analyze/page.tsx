...
photoDescription: 'A clear photo helps the AI identify your product.',
uploadPhoto: 'Tap to upload a photo',
imageFormat: 'JPG or PNG, up to 10MB',
change: 'Change',
removePhoto: 'Remove photo',
productDetails: 'Product details',
priceDescription: 'Prices in rupees (₹). All fields are required.',
...
return ( <div className="mx-auto max-w-4xl"> <div className="mb-6 flex items-start gap-3 rounded-2xl border border-primary/20 bg-primary/5 p-4"> <Info className="mt-0.5 size-5 shrink-0 text-primary" />
